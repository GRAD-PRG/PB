...
![traceertabel met highlights](images/traceertabel-met-highlights.png)

De blauwe highlight toont de uitvoeringen van de *loop body\_* van de `aantal` for loop. De groene highlight toont die van de `k` for loop.
