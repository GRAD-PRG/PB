...
1.  Let op : als je begint met `5/9` ipv `5.0/9` dan ziet de compiler *int gedeeld door int* en zal er een gehele deling uitgevoerd worden (en dan begin je links al met een vermenigvuldiging met `0`)!
