...
[Je hebt misschien al eens gehoord dat computers enkel met nullen en eentjes werken?](https://www.youtube.com/embed/AaZ_RSt0KP8?start=00&end=181) Er zijn in een computer namelijk slechts 2 elektrische spanningsniveaus (waarin de nullen en eentjes zich onderscheiden) omdat dit de elektronica heel wat eenvoudiger en tegelijk ook betrouwbaarder maakt.
...
![voorbeeld tekst encoding correct](images/voorbeeld-tekst-encoding-correct.png)

en vervolgens het bestand openen met ANSI encoding, dan krijgen we deze warboel te zien :

![voorbeeld tekst encoding foutief](images/voorbeeld-tekst-encoding-foutief.png)
...
![voorbeeld color picker](images/voorbeeld-color-picker.png)
