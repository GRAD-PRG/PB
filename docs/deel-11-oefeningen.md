...
Herschrijf [de oplossing van D04score](../deel-04-oplossingen/deel-04-oplossingen.html#_oplossing_d04score) zodat het programma een method `GetLetterCodeForPercentage` gebruikt. Deze method heeft 1 parameter (het percentage) en retourneert de corresponderende lettercode.
...
Herschrijf [de oplossing van D09geenscheldwoorden](../deel-09-oplossingen/deel-09-oplossingen.html#_oplossing_d09geenscheldwoorden) zodat het programma een method `IsAanvaardbaar` gebruikt. Deze method heeft 1 parameter (de tekst) en retourneert een `true` of `false` waarde al naargelang of de tekst aanvaardbaar is of niet.
...
Herschrijf [de oplossing van D07aantalkeere](../deel-07-oplossingen/deel-07-oplossingen.html#_oplossing_d07aantalkeere) zodat het programma een method `GetCharCount` gebruikt. Deze method telt hoe vaak een bepaald karakter in een string voorkomt en retourneert dit aantal.
...
Er is natuurlijk [nog een verband tussen deze opgave en die van oefening D07aantalkeere](https://www.youtube.com/watch?v=meF7NmfnXZ0).
...
> **Belangrijk**
>
> Waarom zou er in deze opgave staan *"Je mag ervan uitgaan dat de gebruiker geen 0 intypt"*?
>
...
We hernemen [de oplossing van D09dierenwissen](../deel-09-oplossingen/deel-09-oplossingen.html#_oplossing_d09dierenwissen) :
...
Het output gedeelte is eigenlijk tijdsverspilling als je alle test arrays wil checken. Zet gewoon een *breakpoint* op regel &lt;1&gt; en kijk dan met de debugger naar de inhoud van de variabelen `testHead0` t.e.m. `testComplete` : ![slice check lokale variabelen](images/slice-check-lokale-variabelen.png)

![debug smart](images/debug-smart.gif)
...
Hiervoor wordt een codewiel en een verschuiving gebruikt (de *offset*), je kunt [de werkwijze hier nalezen](https://www.feestideevoorjou.nl/code-kraken).
