...
1.  We gebruiken de `temp` variabele om tijdelijk een waarde te onthouden tijdens de wissel, net zoals we deden in [de oplossing van D01waardesomwisselen](../deel-01-oplossingen/deel-01-oplossingen.html#_oplossing_d01waardesomwisselen)! Je herinnert je het vast nog wel, [simpelere tijden…​](https://www.youtube.com/watch?v=Gs069dndIYk)
