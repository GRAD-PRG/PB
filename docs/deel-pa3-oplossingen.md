...
1.  ze openen het bestand

2.  ze lezen uit of schrijven naar het `string[]` (dus dat hoef je niet zelf te doen, *convenient*!)

3.  ze sluiten daarna het bestand (dus dat hoef je niet zelf te doen, *convenient*!)

De oplossing met *convenience methods* ziet er zo uit :
...
We zouden de oplossing ook kunnen schrijven m.b.v. `using` en *streams* : `StreamReader` om te lezen en `StreamWriter` om te schrijven.
