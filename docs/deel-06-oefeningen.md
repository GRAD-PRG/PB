...
### ★ Oefening D06twister
Stel, je krijgt voor je 30^e verjaardag het spel Twister cadeau van een kennis. *For privacy’s sake let’s call her Liese M…​ No, that’s too obvious. Uh, let’s say L. Mahieu. [klik](https://www.youtube.com/embed/5oJS9_UUUWg?start=109&amp;end=117&amp;autoplay=1)*

Mocht je dit spel niet kennen, [deze video](https://www.youtube.com/embed/7A5XO0udmdo?autoplay=1) toont hoe het moet (let op het aantal schoenen voor de koelkast!)
...
Dit is één van de zeldzame keren dat je *mad programming skillz* in het dagelijks leven redding kunnen brengen : je besluit een programma te schrijven dat de opdrachten voor je genereert!
...
>
> Om een programma met een oneindige lus te stoppen kun je in de menubalk van Visual Studio kiezen voor **Debug** **›** **Stop Debugging**. Een snellere manier is in de werkbalk op het rode vierkantje te klikken.
...
### ★ Oefening D06simon
Schrijf een programma waarmee de gebruiker het spel *Simon* kan spelen. Mocht je dit spel niet kennen, [deze video](https://www.youtube.com/embed/1Yqj76Q4jJ4?autoplay=1) toont hoe het moet
...
Nadat de gebruiker de code intypt en op ENTER drukt, wordt het scherm gewist en verschijnt er :
...
-   Neem ook de regels op die geen enkele variabele veranderen. Op die manier is het duidelijk hoe de regels van de *loop body* herhaald worden.

-   Voorzie een extra kolom 'Hoeveelste iteratie'. Daarin schrijf je voor de regels van de *loop body* de hoeveelste herhaling het is (eerste, tweede, derde, etc.).
...
Dit is quasi dezelfde opgave als in [oefening D05rechthoek](../deel-05-oefeningen/deel-05-oefeningen.html#_oefening_d05rechthoek), maar baseer je oplossing voor het tekenen van de rechthoek op 1 of meerdere for loops.
